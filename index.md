...
Because each message sent to the list address is distributed to all list members, personal messages and replies should not be posted. If you wish to reply only to the original sender of a post, make sure your reply is directed to that person and not to the list address (seelangs-l@list.iu.edu). If you wish to contact only one subscriber, yet do not know that person’s personal email address, do not use the list address to write to that individual. Instead, make use of the REVIEW seelangs-l command to receive a list of subscribers or write the list owners for assistance.
...
List members who wish to advertise businesses or products in which they have a financial interest are discouraged from doing so on SEELANGS if the businesses or products have nothing to do with Slavic Languages and Literatures. If they do relate to Slavic Languages and Literatures, subscribers are asked to comply with the above guidelines. When in doubt, please send questions to seelangs-l-request@list.iu.edu. 
